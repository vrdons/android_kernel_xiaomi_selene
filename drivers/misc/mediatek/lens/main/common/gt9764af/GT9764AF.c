...
static int s4AF_WriteReg(u16 a_u2Data)
{
	...
	printk("[GT9764AF]  s4GT9764AF_write reg %d\n", i4RetValue);
    if (i4RetValue < 0)
    {
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		char puSendCmd2[2] = { (char)(0x06), (char)(0x80)};
		char puSendCmd3[2] = { (char)(0x07), (char)(0x67)};
...
/* ////////////////////////////////////////////////////////////// */
long GT9764AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
